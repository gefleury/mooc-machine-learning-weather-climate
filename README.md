...
To distinguish the original notebook exercices from my solutions/tests, each original notebook `notebook.ipynb` is copied and renamed as `notebook_GF.ipynb` where I implement my solutions. The notebook files can be found in the subdirectories corresponding to each tier of the MOOC. These include the following:
